...
export default function VideoTemplate({
  ...
  const totalMs = Object.values(activeDurations).reduce((a, b) => a + b, 0);
  ...
  return (
    <div
      data-scene={currentSceneKey}
      className="w-full h-screen overflow-hidden relative bg-bg-dark text-text-inverse"
    >
