  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <motion.img
          src={`${import.meta.env.BASE_URL}images/odyssey-cyclops/rams-escape.png`}
          alt="Rams escape"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-5xl">
        ...
        >
          "At dawn, Odysseus and his men clung beneath the bellies of the great rams..."
        </motion.h2>
        ...
        <motion.div
          ...
          transition={{ duration: 1.5 }}
        >
          "...and slipped past the blinded giant's hands."
        </motion.div>
      </div>
    </motion.div>
  );
