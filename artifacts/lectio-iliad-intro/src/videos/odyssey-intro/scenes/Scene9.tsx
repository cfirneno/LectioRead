  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <motion.img
          src={`${import.meta.env.BASE_URL}images/odyssey-intro/calypso_island.png`}
          alt="Calypso Island"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-5xl">
        ...
        >
          "And now, far from home, Odysseus is held on a lonely island by the nymph Calypso,<br/>
          <motion.span 
            ...
            transition={{ duration: 1.5 }}
          >
            longing only to see the smoke rising from his own Ithaca."
          </motion.span>
        </motion.div>
      </div>
    </motion.div>
