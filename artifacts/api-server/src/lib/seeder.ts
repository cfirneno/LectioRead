...
const CATALOG_QUERIES: Array<{ query: string; title: string; nationality?: "British" | "American" }> = [
  ...
  // ── Shakespeare — complete plays (Act 1 Scene 1 openings, public domain) ──
  // Tragedies
  { query: "William Shakespeare Romeo and Juliet Act 1 Scene 1 opening (Prologue and Sampson/Gregory) in English", title: "Romeo and Juliet", nationality: "British" },
  { query: "William Shakespeare Hamlet Act 1 Scene 1 opening on the battlements in English", title: "Hamlet", nationality: "British" },
  { query: "William Shakespeare Macbeth Act 1 Scene 1 opening (the three witches) in English", title: "Macbeth", nationality: "British" },
  { query: "William Shakespeare Othello Act 1 Scene 1 opening (Iago and Roderigo) in English", title: "Othello", nationality: "British" },
  { query: "William Shakespeare King Lear Act 1 Scene 1 opening in English", title: "King Lear", nationality: "British" },
  { query: "William Shakespeare Julius Caesar Act 1 Scene 1 opening in English", title: "Julius Caesar", nationality: "British" },
  { query: "William Shakespeare Antony and Cleopatra Act 1 Scene 1 opening in English", title: "Antony and Cleopatra", nationality: "British" },
  { query: "William Shakespeare Coriolanus Act 1 Scene 1 opening in English", title: "Coriolanus", nationality: "British" },
  { query: "William Shakespeare Titus Andronicus Act 1 Scene 1 opening in English", title: "Titus Andronicus", nationality: "British" },
  { query: "William Shakespeare Timon of Athens Act 1 Scene 1 opening in English", title: "Timon of Athens", nationality: "British" },
  { query: "William Shakespeare Troilus and Cressida Prologue and Act 1 Scene 1 opening in English", title: "Troilus and Cressida", nationality: "British" },
  // Comedies
  { query: "William Shakespeare A Midsummer Night's Dream Act 1 Scene 1 opening in English", title: "A Midsummer Night's Dream", nationality: "British" },
  { query: "William Shakespeare The Tempest Act 1 Scene 1 opening (the storm) in English", title: "The Tempest", nationality: "British" },
  { query: "William Shakespeare Twelfth Night Act 1 Scene 1 opening ('If music be the food of love') in English", title: "Twelfth Night", nationality: "British" },
  { query: "William Shakespeare Much Ado About Nothing Act 1 Scene 1 opening in English", title: "Much Ado About Nothing", nationality: "British" },
  { query: "William Shakespeare As You Like It Act 1 Scene 1 opening in English", title: "As You Like It", nationality: "British" },
  { query: "William Shakespeare The Merchant of Venice Act 1 Scene 1 opening in English", title: "The Merchant of Venice", nationality: "British" },
  { query: "William Shakespeare The Taming of the Shrew Induction Scene 1 opening in English", title: "The Taming of the Shrew", nationality: "British" },
  { query: "William Shakespeare The Comedy of Errors Act 1 Scene 1 opening in English", title: "The Comedy of Errors", nationality: "British" },
  { query: "William Shakespeare Love's Labour's Lost Act 1 Scene 1 opening in English", title: "Love's Labour's Lost", nationality: "British" },
  { query: "William Shakespeare The Merry Wives of Windsor Act 1 Scene 1 opening in English", title: "The Merry Wives of Windsor", nationality: "British" },
  { query: "William Shakespeare All's Well That Ends Well Act 1 Scene 1 opening in English", title: "All's Well That Ends Well", nationality: "British" },
  { query: "William Shakespeare Measure for Measure Act 1 Scene 1 opening in English", title: "Measure for Measure", nationality: "British" },
  { query: "William Shakespeare The Two Gentlemen of Verona Act 1 Scene 1 opening in English", title: "The Two Gentlemen of Verona", nationality: "British" },
  { query: "William Shakespeare The Winter's Tale Act 1 Scene 1 opening in English", title: "The Winter's Tale", nationality: "British" },
  { query: "William Shakespeare Cymbeline Act 1 Scene 1 opening in English", title: "Cymbeline", nationality: "British" },
  { query: "William Shakespeare Pericles, Prince of Tyre Act 1 Prologue and Scene 1 opening in English", title: "Pericles, Prince of Tyre", nationality: "British" },
  // Histories
  { query: "William Shakespeare King John Act 1 Scene 1 opening in English", title: "King John", nationality: "British" },
  { query: "William Shakespeare Richard II Act 1 Scene 1 opening in English", title: "Richard II", nationality: "British" },
  { query: "William Shakespeare Henry IV Part 1 Act 1 Scene 1 opening in English", title: "Henry IV, Part 1", nationality: "British" },
  { query: "William Shakespeare Henry IV Part 2 Induction and Act 1 Scene 1 opening in English", title: "Henry IV, Part 2", nationality: "British" },
  { query: "William Shakespeare Henry V Act 1 Prologue and Scene 1 opening in English", title: "Henry V", nationality: "British" },
  { query: "William Shakespeare Henry VI Part 1 Act 1 Scene 1 opening in English", title: "Henry VI, Part 1", nationality: "British" },
  { query: "William Shakespeare Henry VI Part 2 Act 1 Scene 1 opening in English", title: "Henry VI, Part 2", nationality: "British" },
  { query: "William Shakespeare Henry VI Part 3 Act 1 Scene 1 opening in English", title: "Henry VI, Part 3", nationality: "British" },
  { query: "William Shakespeare Richard III Act 1 Scene 1 opening ('Now is the winter of our discontent') in English", title: "Richard III", nationality: "British" },
  { query: "William Shakespeare Henry VIII Prologue and Act 1 Scene 1 opening in English", title: "Henry VIII", nationality: "British" },
  ...
  // Mark Twain — complete public-domain works
  ...
  { query: "Mark Twain The Prince and the Pauper Chapter 1 in English", title: "The Prince and the Pauper", nationality: "American" },
  { query: "Mark Twain A Connecticut Yankee in King Arthur's Court Chapter 1 (A Word of Explanation) in English", title: "A Connecticut Yankee in King Arthur's Court", nationality: "American" },
  { query: "Mark Twain The Tragedy of Pudd'nhead Wilson Chapter 1 in English", title: "Pudd'nhead Wilson", nationality: "American" },
  { query: "Mark Twain Life on the Mississippi Chapter 1 (The River and Its History) in English", title: "Life on the Mississippi", nationality: "American" },
  { query: "Mark Twain The Innocents Abroad Chapter 1 in English", title: "The Innocents Abroad", nationality: "American" },
  { query: "Mark Twain Roughing It Chapter 1 in English", title: "Roughing It", nationality: "American" },
  { query: "Mark Twain A Tramp Abroad Chapter 1 in English", title: "A Tramp Abroad", nationality: "American" },
  { query: "Mark Twain Following the Equator Chapter 1 in English", title: "Following the Equator", nationality: "American" },
  { query: "Mark Twain Personal Recollections of Joan of Arc Book 1 Chapter 1 in English", title: "Personal Recollections of Joan of Arc", nationality: "American" },
  { query: "Mark Twain Tom Sawyer Abroad Chapter 1 in English", title: "Tom Sawyer Abroad", nationality: "American" },
  { query: "Mark Twain Tom Sawyer, Detective Chapter 1 in English", title: "Tom Sawyer, Detective", nationality: "American" },
  { query: "Mark Twain The Celebrated Jumping Frog of Calaveras County full short story opening in English", title: "The Celebrated Jumping Frog of Calaveras County", nationality: "American" },
  { query: "Mark Twain The Man That Corrupted Hadleyburg opening in English", title: "The Man That Corrupted Hadleyburg", nationality: "American" },
  { query: "Mark Twain The £1,000,000 Bank-Note (The Million Pound Bank Note) opening in English", title: "The £1,000,000 Bank-Note", nationality: "American" },
  { query: "Mark Twain The Mysterious Stranger Chapter 1 in English", title: "The Mysterious Stranger", nationality: "American" },
