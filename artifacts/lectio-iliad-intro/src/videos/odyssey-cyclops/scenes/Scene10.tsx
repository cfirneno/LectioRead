  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-5xl">
        <motion.h1
          className="text-[7vw] font-display text-text-inverse tracking-widest leading-none mb-6"
        ...
        <motion.div
          className="text-[2.5vw] font-display text-secondary/70 mb-12"
          initial={{ opacity: 0 }}
        ...
        <motion.div
          ...
          transition={{ duration: 1.5 }}
        >
          "Cunning saved him — but pride called down a god's curse."
        </motion.div>
      </div>
    </motion.div>
  );
