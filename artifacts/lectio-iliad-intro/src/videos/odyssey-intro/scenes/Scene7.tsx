  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <motion.img
          src={`${import.meta.env.BASE_URL}images/odyssey-intro/ship_storm.png`}
          alt="Ship in storm"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-5xl">
        ...
        >
          "He saw the cities of many people and learned their minds.<br/>
          <motion.span 
            ...
            transition={{ duration: 1.5 }}
          >
            On the open sea he suffered sorrow after sorrow, fighting for his life and the homecoming of his men."
          </motion.span>
        </motion.div>
      </div>
    </motion.div>
