  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full text-center px-12 flex flex-col items-center">
        <div className="text-[4.5vw] font-display text-text-inverse leading-tight flex justify-center flex-wrap gap-4 drop-shadow-2xl mb-8">
          <motion.span
        ...
        <motion.div
          ...
          transition={{ duration: 1.5 }}
        >
          "the fairest star set in the sky"
        </motion.div>
      </div>
    </motion.div>
  );
