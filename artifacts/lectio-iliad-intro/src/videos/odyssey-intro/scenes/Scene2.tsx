  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-4xl">
        ...
        >
          "It begins not with a goddess, and not with wrath, but with a man.<br/>
          <motion.span 
            className="text-secondary mt-4 block"
            initial={{ opacity: 0 }} 
            animate={phase >= 2 ? { opacity: 1 } : { opacity: 0 }}
            transition={{ duration: 1.5 }}
          >
            In Greek, ἄνδρα &mdash; a man of many turns, many troubles, many disguises."
          </motion.span>
        </motion.div>
      </div>
    </motion.div>
